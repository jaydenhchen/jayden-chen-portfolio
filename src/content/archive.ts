...
export const cgiVideos: ArchiveVideo[] = [
  ...
  { slug: 'final-animation', src: `${streamMedia}/final.mp4`, title: 'Arcane - Ma Meilleure Ennemie but in LEGO', alt: 'Final animation export', year: '2025', href: '/cgi/final-animation', tools: cgiOnlyTools, youtubeUrl: 'https://www.youtube.com/watch?v=8ZDylshw-cs' },
  ...
  { slug: 'lego-field-trip', src: `${streamMedia}/field-trip.mp4`, title: 'Kanye West – FIELD TRIP | Music Video', alt: 'LEGO Field Trip animation', year: '2024', href: '/cgi/lego-field-trip', tools: cgiOnlyTools, youtubeUrl: 'https://www.youtube.com/watch?v=LMruuUC5wAw' },
