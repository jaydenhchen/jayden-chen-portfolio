import { cgiTools, fusion360Tools, getProjectBySlug, getProjectPath, type MediaAsset } from './projects'
...
export const cgiVideos: ArchiveVideo[] = [
  ...
  { slug: 'invincible', src: `${streamMedia}/invincible4final.mp4`, title: 'Invincible - Season 4 Unofficial Teaser Trailer', alt: 'Invincible animation', year: '2025', href: '/cgi/invincible', tools: cgiTools, youtubeUrl: 'https://www.youtube.com/watch?v=MD6KvNZ-Djc' },
  { slug: 'final-animation', src: `${streamMedia}/final.mp4`, title: 'Arcane - Ma Meilleure Ennemie but in LEGO', alt: 'Final animation export', year: '2025', href: '/cgi/final-animation', tools: cgiTools, youtubeUrl: 'https://www.youtube.com/watch?v=8ZDylshw-cs' },
  createProjectVideo('drone-deconstruction-animation'),
  { slug: 'lego-debate', src: `${streamMedia}/debate2-final.mp4`, title: 'Trump and Harris Presidential Debate but in LEGO', alt: 'LEGO debate animation', year: '2024', href: '/cgi/lego-debate', tools: cgiTools, youtubeUrl: 'https://www.youtube.com/watch?v=YlhEZTxmDlA' },
  { slug: 'lego-grammy', src: `${streamMedia}/grammy-final.mp4`, title: 'Kanye West Wins Grammy Best Rap Album Speech but in LEGO', alt: 'LEGO Grammy animation', year: '2024', orientation: 'portrait', href: '/cgi/lego-grammy', tools: cgiTools, youtubeUrl: 'https://www.youtube.com/watch?v=7DuW4mAjFag' },
  { slug: 'lego-field-trip', src: `${streamMedia}/field-trip.mp4`, title: 'Kanye West – FIELD TRIP | Music Video', alt: 'LEGO Field Trip animation', year: '2024', href: '/cgi/lego-field-trip', tools: cgiTools, youtubeUrl: 'https://www.youtube.com/watch?v=LMruuUC5wAw' },
  { slug: 'lego-bomb', src: `${streamMedia}/bomb-final.mp4`, title: 'Kanye West - BOMB (feat. North West) | LEGO Music Video', alt: 'LEGO Bomb animation', year: '2024', href: '/cgi/lego-bomb', tools: cgiTools, youtubeUrl: 'https://www.youtube.com/watch?v=8mdvX56404U' },
  { slug: 'shortform', src: `${streamMedia}/shortform.mp4`, title: 'Wholly Custom LEGO Set, Box, and Rendering', alt: 'Shortform animation', year: '2025', orientation: 'portrait', href: '/cgi/shortform', tools: cgiTools },
]
